...
describe("url_parser_does_work", function()
  it("urls", function()
    ...
    assert.equals("https://signin.aws.amazon.com/switchrole?roleName=my-role&account=111111111",
      handler.handle("v", "https://signin.aws.amazon.com/switchrole?roleName=my-role&account=111111111")
      )
  end)
